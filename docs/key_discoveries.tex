...
\begin{itemize}
  \item \textbf{Ghost/Phantom EFT:} $E_{\rm tot} = -2.23\times10^{-13}\,$J, stability = 0.997, $\rho_{\max}=-1.37\times10^{-15}\,$J/m³  
  \item \textbf{Metamaterial Casimir:} $E_{\rm tot} = -3.14\times10^{-2}\,$J, stability = 8.9\times10^{-10}$ (unstable)  
  \item \textbf{Mesh nodes:} 3 600; validation runtime < 0.006 s  
\end{itemize}
